...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i> Add Employees</h1>
        </div>
        ...
        <form method="post" action="<?php $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label class="control-label">Employee's Firstname</label>
                  <input class="form-control" type="text" name="fname" placeholder="Employee's Firstname" required value="<?php echo $employee['firstname'] ?>" />
                </div>
                <div class="form-group">
                  <label class="control-label">Employee's Lastname</label>
                  <input class="form-control" type="text" name="lname" placeholder="Employee's Lastname" required value="<?php echo $employee['lastname'] ?>" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="dob" placeholder="Employee's Date of Birth" value="<?php echo $employee['dob'] ?>" />
                </div>
                <div class="form-group">
          ...
          <div class="tile-footer">
              <button class="btn btn-info" id="demoNotify" type="submit" name="update">
                <i class="fa fa-save"></i> Update Employee's Record
              </button>
          </div>
        </form>
      </div>
