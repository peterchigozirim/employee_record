            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="fname" placeholder="Employee's Firstname" required />
                </div>
                <div class="form-group">
                  <label class="control-label">Employee's Lastname</label>
                  <input class="form-control" type="text" name="lname" placeholder="Employee's Lastname" required />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" type="date" name="dob" placeholder="Employee's Date of Birth" />
                </div>
                <div class="form-group">
                  <label class="control-label">Address</label>
                  <input class="form-control" type="text" name="address" placeholder="Employee Address" />
                </div>
                <div class="form-group">
