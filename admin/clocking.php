  ...
  <body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="tile">
            <h3 class="tile-title">Find Employee</h3>
            <form name="frm_search_emp">
                <div class="mb-4">
                    <label for="emp_id">Employee's ID</label>
                    <input type="text" class="form-control" name="emp_id" id="emp_id" placeholder="Enter Employee's ID" required />
                </div>
                
                <div>
                    <button class="btn btn-primary" type="submit">
                        <i class="fa fa-search"></i> Fetch Employee
                    </button>
                </div>
            </form>
          </div>
